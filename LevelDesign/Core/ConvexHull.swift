...
final class ConvexHull {
    ...
    func quickHull(points: [CGPoint]) -> Polygon {
        var pts = points
    ...
    private func findHull(_ points: [CGPoint], _ p1: CGPoint, _ p2: CGPoint) {
    ...
    private func distance(from p: CGPoint, to line: (CGPoint, CGPoint)) -> CGFloat {
