...
- (id)initWithEdge:(CGPoint)p1 To:(CGPoint)p2 IsDynamic:(BOOL)isDynamic Position:(CGPoint)position Density:(float)density Friction:(float)friction Restitution:(float)restitution AtWorld:(ZPWorld *)world {
    ...
    self = [self initWithShape:&shape Type:type Position:position Density:density Friction:friction Restitution:restitution World:world];
...
- (id)initWithPolygon:(NSArray<NSValue *> *)points IsDynamic:(BOOL)isDynamic Position:(CGPoint)position Density:(float)density Friction:(float)friction Restitution:(float)restitution AtWorld:(ZPWorld *)world {
    ...
    self = [self initWithShape:&boxShape Type:type Position:position Density:density Friction:friction Restitution:restitution World:world];
...
- (id)initWithShape:(b2Shape *)shape Type:(b2BodyType)type Position:(CGPoint)position Density:(float)density Friction:(float)friction Restitution:(float)restitution World:(ZPWorld *)world {
    self = [super init];
